...
bool GameScene::OnCreate() {
	...
	JsonParser* jsp = new JsonParser("./Resources/Test.json");
	...
	SceneGraph::GetInstance()->GetGameObject("apple")->SetScale(glm::vec3(0.5f));
	...
	SceneGraph::GetInstance()->GetGameObject("apple")->GetComponent<AudioSource>()->PlaySound();
